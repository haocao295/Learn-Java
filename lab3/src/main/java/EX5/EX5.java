...
public class EX5 extends javax.swing.JFrame {
    ...
    private List<HinhChuNhat> list = new ArrayList<>();

    public EX5() {
        initComponents();
        mode1.addColumn("Chieu Dai");
        mode1.addColumn("Chieu Rong");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        list.add(hcn);
        Object[] row = {hcn.getChieudai(), hcn.getChieurong(), hcn.getDienTich(), hcn.getChuVi()};
        mode1.addRow(row);
